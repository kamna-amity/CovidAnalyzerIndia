...
public class JavaScriptFunctionService {
    ...
    public String getJavaScriptFunctionCall(String graphType, String graphLabel1, String graphLabel2,
                                            String graphBackground1, String graphBackground2,
                                            String graphBorder1, String graphBorder2,
                                            String graphX, String graphY1, String graphY2, String aspectRatio){
        StringBuilder javaScriptFunctionCall = new StringBuilder();
        javaScriptFunctionCall.append("javascript:displayChart(")
                .append("'")
                .append(graphType)
