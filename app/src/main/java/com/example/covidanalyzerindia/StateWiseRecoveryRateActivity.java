...
public class StateWiseRecoveryRateActivity extends AppCompatActivity {
    ...
    private static final String GRAPH_LABEL = "Recovery Rate";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_state_wise_recovery_rate);
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = StateWiseRecoveryRateActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getStateWiseRecoveryRateString();

                    WebView myWebView = findViewById(R.id.stateWiseRecoveryRateWebView);
