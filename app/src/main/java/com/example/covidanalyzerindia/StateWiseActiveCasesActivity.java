...
public class StateWiseActiveCasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_state_wise_active_cases);
        ...
        try {
            new StateWiseActiveCasesActivity.AsyncCovidDataApiTask().execute(CovidDataService.COVID_DATA_RESOURCE);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = StateWiseActiveCasesActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getStateWiseCasesActiveCasesString();

                    WebView myWebView = findViewById(R.id.stateWiseActiveCasesWebView);
