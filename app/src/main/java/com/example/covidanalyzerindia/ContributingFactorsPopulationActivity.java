...
public class ContributingFactorsPopulationActivity extends AppCompatActivity {
    ...
    private static final String GRAPH_LABEL_POPULATION = "Population";
