...
public class StateWiseDeathRateActivity extends AppCompatActivity {
    ...
    private static final String GRAPH_LABEL = "Death Rate";
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = StateWiseDeathRateActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getStateWiseDeathRateString();

                    WebView myWebView = findViewById(R.id.stateWiseDeathRateWebView);
