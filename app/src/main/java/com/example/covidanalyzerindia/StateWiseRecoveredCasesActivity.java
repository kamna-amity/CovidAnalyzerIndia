...
public class StateWiseRecoveredCasesActivity extends AppCompatActivity {
    ...
    private static final String GRAPH_LABEL = "Number of Recovered Cases";
    private static final String GRAPH_BACKGROUND_COLOR = RECOVERED_COLOR;
    private static final String GRAPH_BORDER_COLOR = RECOVERED_COLOR;
    private static final String GRAPH_ASPECT_RATIO = "0.6";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_state_wise_recovered_cases);
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = StateWiseRecoveredCasesActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getStateWiseCasesRecoveredCasesString();

                    WebView myWebView = findViewById(R.id.stateWiseRecoveredCasesWebView);
