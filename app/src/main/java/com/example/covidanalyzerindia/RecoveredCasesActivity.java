...
public class RecoveredCasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recovered_cases);
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = RecoveredCasesActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getCaseTimeSeriesDailyRecoveredCasesString();

                    WebView myWebView = findViewById(R.id.recoveredCasesWebView);
