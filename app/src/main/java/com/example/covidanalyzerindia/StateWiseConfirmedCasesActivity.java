...
public class StateWiseConfirmedCasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_state_wise_confirmed_cases);
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = StateWiseConfirmedCasesActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getStateWiseCasesConfirmedCasesString();

                    WebView myWebView = findViewById(R.id.stateWiseConfirmedCasesWebView);
