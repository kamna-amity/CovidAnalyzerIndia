...
public class ActiveCasesActivity extends AppCompatActivity {
    ...
    private class AsyncCovidDataApiTask extends AsyncTask<String, String, CovidDataService> {
        ...
        private final String TAG = ActiveCasesActivity.AsyncCovidDataApiTask.class.getSimpleName();
        ...
        protected void onPostExecute(CovidDataService covidDataService) {
            ...
            if (covidDataService != null) {
                try {
                    ...
                    final String graphY = covidDataService.getCaseTimeSeriesDailyActiveCasesString();

                    WebView myWebView = findViewById(R.id.activeCasesWebView);
